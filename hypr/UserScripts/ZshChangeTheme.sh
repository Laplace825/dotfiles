...
themes_custom_dir="$HOME/.oh-my-zsh/custom/themes"
file_extension=".zsh-theme"

themes_array=($(find "$themes_dir" "$themes_custom_dir" -type f -name "*$file_extension" -exec basename {} \; | sed -e "s/$file_extension//"))
